...
This skill exports a AStockPursue strategy to **all major trading platforms** in one go.
...
```pinescript
// This strategy was generated by AStockPursue
...
```mql5
//+------------------------------------------------------------------+
//| Generated by AStockPursue                                         |
//+------------------------------------------------------------------+
#property copyright "AStockPursue"
...
When generating code, map AStockPursue instrument codes appropriately:

| AStockPursue | TradingView | 通达信/同花顺 | MT5 |
|-------------|-------------|---------------|-----|
...
- [ ] Comment header notes the original AStockPursue run_id and instrument
