...
_ALLOWED_FILE_ROOTS_ENV = "ASTOCKPURSUE_ALLOWED_FILE_ROOTS"
_ALLOWED_RUN_ROOTS_ENV = "ASTOCKPURSUE_ALLOWED_RUN_ROOTS"
...
def _default_file_roots() -> list[Path]:
    ...
    return [
        ...
        cwd / "uploads",
        cwd / "data",
        home / ".AStockPursue" / "uploads",
        home / ".AStockPursue" / "imports",
    ]
