...
def _build_variables(preset_name: str, prompt: str) -> dict[str, str]:
    ...
    # Preset-specific variable sets (see backend/src/swarm/presets/*.yaml).
...
class SwarmTool(BaseTool):
    ...
    description = (
        ...
        "Provide a natural language prompt; the tool picks a preset from backend/src/swarm/presets "
