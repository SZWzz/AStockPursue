...
_ENV_PATH = "ASTOCKPURSUE_HYPOTHESES_PATH"
...
def default_hypotheses_path() -> Path:
    ...
    Returns:
        Env override path when ``ASTOCKPURSUE_HYPOTHESES_PATH`` is set,
        otherwise ``~/.AStockPursue/hypotheses.json``.
    """
    override = os.environ.get(_ENV_PATH, "").strip()
    if override:
        return Path(override).expanduser()
    return Path.home() / ".AStockPursue" / "hypotheses.json"
...
class Hypothesis:
    ...
    Attributes:
        ...
        skills: Relevant AStockPursue skills.
    ...
    def create(
        ...
        *,
        ...
        Args:
            ...
            skills: Related AStockPursue skills.
