...
Output:
    ~/.AStockPursue/reports/alpha_bench_*.html      — per-run HTML reports
    ~/.AStockPursue/reports/bench_<zoo>_<uni>.json  — per-run raw results
    ~/.AStockPursue/reports/bench_summary.json      — aggregate summary
...
REPORTS_DIR = Path.home() / ".AStockPursue" / "reports"
