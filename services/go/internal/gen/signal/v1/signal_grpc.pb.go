...
const (
	SignalService_GenerateSignals_FullMethodName = "/astockpursue.signal.SignalService/GenerateSignals"
)
...
func (c *signalServiceClient) GenerateSignals(ctx context.Context, in *SignalRequest, opts ...grpc.CallOption) (*SignalResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SignalResponse)
	err := c.cc.Invoke(ctx, SignalService_GenerateSignals_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSignalServiceServer) GenerateSignals(context.Context, *SignalRequest) (*SignalResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateSignals not implemented")
}
...
func _SignalService_GenerateSignals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SignalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SignalServiceServer).GenerateSignals(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SignalService_GenerateSignals_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SignalServiceServer).GenerateSignals(ctx, req.(*SignalRequest))
	}
...
var SignalService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "astockpursue.signal.SignalService",
	HandlerType: (*SignalServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GenerateSignals",
			Handler:    _SignalService_GenerateSignals_Handler,
		},
	},
