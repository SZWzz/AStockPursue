...
const (
	LLMService_Chat_FullMethodName        = "/astockpursue.llm.LLMService/Chat"
	LLMService_AgentDecide_FullMethodName = "/astockpursue.llm.LLMService/AgentDecide"
)
...
type LLMServiceClient interface {
	...
	AgentDecide(ctx context.Context, in *AgentRequest, opts ...grpc.CallOption) (*AgentResponse, error)
}
...
func (c *lLMServiceClient) AgentDecide(ctx context.Context, in *AgentRequest, opts ...grpc.CallOption) (*AgentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AgentResponse)
	err := c.cc.Invoke(ctx, LLMService_AgentDecide_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LLMServiceServer interface {
	...
	AgentDecide(context.Context, *AgentRequest) (*AgentResponse, error)
...
func (UnimplementedLLMServiceServer) AgentDecide(context.Context, *AgentRequest) (*AgentResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AgentDecide not implemented")
}
...
func _LLMService_AgentDecide_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AgentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LLMServiceServer).AgentDecide(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LLMService_AgentDecide_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LLMServiceServer).AgentDecide(ctx, req.(*AgentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LLMService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "astockpursue.llm.LLMService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AgentDecide",
			Handler:    _LLMService_AgentDecide_Handler,
		},
	},
