...
const STARS_CACHE_KEY = "AStockPursue-github-stars";
...
function setMeta(page, version) {
  document.title = `${page.title} - AStockPursue Docs`;
  const description = page.description || page.lead || "AStockPursue documentation.";
  document.querySelector('meta[name="description"]')?.setAttribute("content", description);
  document.querySelector('meta[property="og:title"]')?.setAttribute("content", `${page.title} - AStockPursue Docs`);
  document.querySelector('meta[property="og:description"]')?.setAttribute("content", description);
  const canonical = `https://AStockPursue.wiki${canonicalPath(page.id, version)}`;
