...
export const DOCS_DEFAULT_PAGE = "getting-started/AStockPursue-overview";
...
export const DOCS_STRUCTURE = [
  {
    ...
    pages: [
      {
        id: "getting-started/AStockPursue-overview",
        title: "AStockPursue overview",
        description: "What AStockPursue is, where it fits, and what boundary it keeps.",
        lead: "AStockPursue is an open-source finance research workspace that turns natural-language prompts into market-data pulls, backtests, reports, and reusable research context.",
        sections: [
          {
            id: "what-it-is",
            title: "What it is",
            body: `
              <p>AStockPursue connects an agent loop to finance tools: data loaders, strategy generation, backtest engines, document readers, trade-journal analysis, persistent memory, and multi-agent research teams.</p>
          ...
          },
          {
            ...
            title: "Research only",
            body: `
              <p>AStockPursue does not execute live trades. It is designed for simulation, backtesting, audit trails, and research workflows. Outputs are not investment advice.</p>
            `
          },
          {
            id: "capabilities",
      ...
      },
      {
        ...
        title: "Quick start",
        description: "Install AStockPursue, initialize configuration, and run the first research task.",
        ...
        sections: [
          {
            ...
            title: "Install",
            body: `
              <pre><code>pip install AStockPursue-ai
AStockPursue init
AStockPursue</code></pre>
            `
          },
          {
            id: "first-run",
            title: "First run",
            body: `
              <pre><code>AStockPursue run -p "Backtest a BTC-USDT 20/50 moving-average strategy for 2024, summarize return and drawdown, then export the report"</code></pre>
            `
          },
          {
            id: "web-ui",
            ...
            body: `
              <pre><code>AStockPursue serve --port 8899</code></pre>
      ...
      },
      {
        ...
        lead: "AStockPursue keeps secrets and deployment-specific choices in environment variables or local Settings, not in source files.",
        sections: [
          {
            id: "env",
...
TIMEOUT_SECONDS=2400</code></pre>
              <p>Run <code>AStockPursue init</code> to bootstrap the local configuration interactively.</p>
            `
          },
          {
            id: "keys",
    ...
    pages: [
      {
        ...
        description: "How a AStockPursue run moves from prompt to evidence.",
      ...
      },
      {
        ...
        lead: "AStockPursue backtests daily and minute strategies across multiple asset classes, then keeps outputs auditable with metrics and run cards.",
        sections: [
          {
            id: "engines",
            title: "Engines",
          ...
          },
          {
            ...
            title: "Example",
            body: `
              <pre><code>AStockPursue run -p "Backtest an equal-weight SPY and BTC-USDT momentum rotation strategy for 2024 with benchmark comparison"</code></pre>
            `
          }
        ]
      },
        ...
        sections: [
          {
            ...
            title: "Presets",
            body: `
              <p>AStockPursue includes 29 presets such as investment committee, quant strategy desk, crypto trading desk, macro rates and FX desk, and risk committee.</p>
              <pre><code>AStockPursue --swarm-presets
AStockPursue --swarm-run investment_committee '{"topic":"BTC outlook"}'</code></pre>
            `
          },
          {
            id: "keys",
    ...
    pages: [
      {
        ...
        title: "Data sources",
        description: "How AStockPursue routes symbols and market data providers.",
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            title: "Example",
            body: `
              <pre><code>AStockPursue --upload trades_export.csv
AStockPursue run -p "Analyze my trading behavior, extract my shadow strategy, and compare it with my actual trades"</code></pre>
            `
          }
        ]
      },
        ...
        sections: [
          {
            ...
            title: "Library",
            body: `
              <p>AStockPursue bundles specialized skills across data sources, strategy generation, analysis, options, reporting, tools, and risk workflows.</p>
        ...
        sections: [
          {
            ...
            body: `
              <pre><code>AStockPursue
AStockPursue init
AStockPursue run -p "your research prompt"
AStockPursue --upload report.pdf
AStockPursue memory list
AStockPursue serve --port 8899
AStockPursue-mcp</code></pre>
            `
          },
          {
            id: "interactive",
      ...
      },
      {
        ...
        title: "MCP server",
        description: "Expose AStockPursue tools to MCP-compatible clients.",
        lead: "The MCP server runs as a stdio subprocess and exposes AStockPursue tools to agent clients.",
        sections: [
          {
            id: "start",
            title: "Start",
            body: `
              <pre><code>AStockPursue-mcp</code></pre>
            `
          },
          {
            id: "config",
        ...
        sections: [
          {
            ...
            body: `
              <ul>
                ...
                <li>Custom domain: <code>AStockPursue.wiki</code></li>
              </ul>
            `
          },
          {
