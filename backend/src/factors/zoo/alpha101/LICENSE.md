...
This is the display name used throughout the AStockPursue codebase, manifests,
wiki, and documentation when referring to the 101 alphas implemented under
`backend/src/factors/zoo/alpha101/`. No other branding is used.
...
top of the operator surface in `backend/src/factors/base.py`. The
