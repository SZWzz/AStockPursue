"""Shadow Account persistence (~/.AStockPursue/shadow_accounts/).

Layout:
    ~/.AStockPursue/shadow_accounts/<shadow_id>.json   ShadowProfile
    ~/.AStockPursue/shadow_runs/<shadow_id>/           backtest run dir
    ~/.AStockPursue/shadow_reports/<shadow_id>.pdf     rendered report
"""
