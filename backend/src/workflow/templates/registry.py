...
TEMPLATES: List[Dict[str, Any]] = [
    ...
    # ── 2. Dual MA crossover ───────────────────────────────────────────────
    {
        ...
        "nodes": [
            ...
            {"id": "t_golden", "node_type": "cross_over", "label": "Golden Cross",
             "position": {"x": 520, "y": -180}, "config": {"direction": "above", "event_type": "entry"}},
            {"id": "t_death", "node_type": "cross_over", "label": "Death Cross",
             "position": {"x": 520, "y": -20}, "config": {"direction": "below", "event_type": "exit"}},
    ...
    },
    {
        ...
        "nodes": [
            ...
            {"id": "d_golden", "node_type": "cross_over", "label": "Golden Cross", "position": {"x": 520, "y": -180}, "config": {"direction": "above", "event_type": "entry"}},
            {"id": "d_death", "node_type": "cross_over", "label": "Death Cross", "position": {"x": 520, "y": -20}, "config": {"direction": "below", "event_type": "exit"}},
