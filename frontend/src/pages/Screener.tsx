      ...
      <div className="flex gap-3 flex-1 min-h-0">
        ...
        <div className="w-80 shrink-0 border rounded-xl p-3 flex flex-col gap-2 overflow-y-auto">
          ...
          <div className="space-y-1">
            <label className="text-[10px] text-muted-foreground uppercase tracking-wider flex items-center gap-1"><Globe className="h-3 w-3" />Universe</label>
            ...
            {universePreset === "custom" && (
              <div className="flex gap-1">
                ...
                />
                <button onClick={applyCustomUniverse} className="px-2 py-1 text-xs bg-primary text-primary-foreground rounded">Apply</button>
              </div>
            )}
            <p className="text-[10px] text-muted-foreground">{store.universe.length} stocks in universe</p>
          </div>
